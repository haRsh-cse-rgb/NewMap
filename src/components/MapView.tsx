...
// // ---------- 1. MASK COMPONENT (Hides non-India regions) ----------
// const IndiaMask = ({ geoJsonData }: { geoJsonData: any }) => {
...
//     const holes: any[] = [];
//     const flip = (coords: any[]) => coords.map((c: any) => [c[1], c[0]]);

//     geoJsonData.features.forEach((feature: any) => {
//       if (feature.geometry.type === 'Polygon') {
//         holes.push(flip(feature.geometry.coordinates[0]));
//       } else if (feature.geometry.type === 'MultiPolygon') {
//         feature.geometry.coordinates.forEach((poly: any) => {
//           holes.push(flip(poly[0]));
//         });
//       }
//     });
...
//       <IndiaMask geoJsonData={geoJsonData} />
